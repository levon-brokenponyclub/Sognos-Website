...
export default function AboutPage() {
  return (
    <main className="w-full bg-white">
      ...
      {/* Hero Bento */}
      <section className="w-full bg-[#FAFAFA] pt-32 pb-24 border-b border-gray-100 overflow-hidden relative">
        <div className="max-w-[1400px] w-full mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-semibold text-[#0F172A] tracking-[-0.02em] mb-6">
              Company
            </h1>
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed font-light">
              Built to serve the organisations that serve others. <br className="hidden md:block" />
              Since 2016, Sognos has helped service organisations work smarter — replacing disconnected tools with a single intelligent platform built natively on Microsoft Dynamics 365.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-4 lg:gap-5 min-h-[640px]">

            {/* Left Column */}
            <div className="md:col-span-2 lg:col-span-3 flex flex-col gap-4 lg:gap-5">
              {/* Stat 1 (Dark Block) */}
              <div className="rounded-[2rem] bg-[#0F172A] text-white p-8 lg:p-10 flex flex-col justify-end flex-shrink-0 h-[280px] lg:h-[310px] shadow-sm transform transition hover:-translate-y-1 hover:shadow-xl duration-500">
                <p className="text-5xl lg:text-6xl font-semibold mb-3 tracking-tight">2016</p>
                <p className="text-sm font-medium text-gray-300">Founded</p>
              </div>

              {/* Stat 2 (Image Block) */}
              <div className="rounded-[2rem] relative overflow-hidden flex-1 min-h-[280px] p-8 lg:p-10 flex flex-col justify-end shadow-sm transform transition hover:-translate-y-1 hover:shadow-xl duration-500 group">
                <Image src="/images/industries/facilities-management.webp" alt="Team collaboration" fill className="object-cover transition duration-1000 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0F172A]/90 via-[#0F172A]/30 to-transparent"></div>
                <div className="relative z-10 text-white">
                  <p className="text-5xl lg:text-6xl font-semibold mb-3 tracking-tight">9+</p>
                  <p className="text-sm font-medium text-gray-200">Years in field service</p>
                </div>
              </div>
            </div>

            {/* Center Column */}
            <div className="md:col-span-2 lg:col-span-5 relative rounded-[2rem] overflow-hidden min-h-[400px] shadow-sm group transform transition hover:-translate-y-1 hover:shadow-xl duration-500">
              <Image src="/images/industries/health-social-care.webp" alt="Working together" fill className="object-cover shadow-inner transition duration-1000 group-hover:scale-105" />
            </div>

            {/* Right Column */}
            <div className="md:col-span-4 lg:col-span-4 flex flex-col gap-4 lg:gap-5">
              {/* Wide Image Block */}
              <div className="relative rounded-[2rem] overflow-hidden flex-shrink-0 h-[280px] lg:h-[310px] w-full shadow-sm group transform transition hover:-translate-y-1 hover:shadow-xl duration-500">
                <Image src="/images/industries/energy-utilities.webp" alt="Office meeting" fill className="object-cover transition duration-1000 group-hover:scale-105" />
              </div>

              <div className="flex flex-col sm:flex-row gap-4 lg:gap-5 flex-1 min-h-[280px]">
                {/* Stat 3 (Dark Block) */}
                <div className="rounded-[2rem] bg-[#0F172A] text-white p-6 lg:p-8 flex flex-col justify-end flex-1 shadow-sm transform transition hover:-translate-y-1 hover:shadow-xl duration-500">
                  <p className="text-4xl lg:text-5xl font-semibold mb-3 tracking-tight">3</p>
                  <p className="text-sm font-medium text-gray-300">Countries served</p>
                </div>

                {/* Stat 4 (Image Block) */}
                <div className="rounded-[2rem] relative overflow-hidden flex-1 p-6 lg:p-8 flex flex-col justify-end shadow-sm transform transition hover:-translate-y-1 hover:shadow-xl duration-500 group min-h-[250px]">
                  <Image src="/images/industries/local-government.webp" alt="Users using platform" fill className="object-cover transition duration-1000 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0F172A]/90 via-[#0F172A]/30 to-transparent"></div>
                  <div className="relative z-10 text-white">
                    <p className="text-4xl lg:text-5xl font-semibold mb-3 tracking-tight">1,100+</p>
                    <p className="text-sm font-medium text-gray-200">Users on platform</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="w-full bg-[#FAFAFA] border-b border-sognos-border-subtle">
        <div className="max-w-7xl w-full mx-auto px-6 py-24 lg:py-32">
          ...
          <div className="mb-16 lg:mb-20">
            ...
            <h2 className="font-heading text-4xl lg:text-6xl font-semibold text-prussian-blue-800 tracking-tight leading-[1.1]">
              ...
              <span className="text-gray-400">our vision & mission</span> explained
            </h2>
          </div>

          {/* Mission & Vision Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-gray-200 border border-gray-200 rounded-3xl overflow-hidden shadow-sm mb-24 lg:mb-32">

            {/* Mission Card */}
            <div className="bg-white p-10 lg:p-14 flex flex-col">
              <h3 className="font-heading text-3xl font-semibold text-prussian-blue-800 mb-8">Mission</h3>
              <p className="text-gray-600 leading-relaxed text-lg mb-10">
                By leveraging modern business applications — centred on Microsoft Dynamics 365 — we simplify processes, solve operational challenges, and deliver measurable value for the organisations that keep communities running.
              </p>
              <div className="mt-auto p-8 rounded-2xl bg-[#F8FAFC] border border-gray-100">
                <p className="italic text-gray-500 text-sm leading-relaxed mb-4">
                  "We simplify processes, solve operational challenges, and deliver measurable value for those who serve others."
                </p>
                <p className="text-xs font-bold text-prussian-blue-800 uppercase tracking-wide">— Our Commitment</p>
              </div>
            </div>

            {/* Vision Card */}
            <div className="bg-white p-10 lg:p-14 flex flex-col">
              <h3 className="font-heading text-3xl font-semibold text-prussian-blue-800 mb-8">Vision</h3>
              <p className="text-gray-600 leading-relaxed text-lg mb-10">
                To be first in field service. We aim to set the global standard for operational excellence in service-led organisations through innovation and native cloud technology.
              </p>
              <div className="mt-auto flex flex-wrap gap-2">
                {["Innovation", "Operational Excellence", "Cloud Native", "Field Service", "D365 Expertise", "Direct Impact"].map((tag) => (
                  <span key={tag} className="px-3 py-2 rounded-lg bg-gray-50 border border-gray-100 text-[11px] font-semibold text-gray-500">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-4 lg:space-y-6">
              {PARTNERS.map((partner) => (
                <div
                  key={partner.name}
                  className="group bg-slate-50 border border-sognos-border-subtle rounded-2xl overflow-hidden flex flex-col sm:flex-row transition-all duration-300 hover:shadow-md hover:border-[#1D96FC]/30"
                >
                  {/* Logo cell */}
