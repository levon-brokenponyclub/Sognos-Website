...
const solutions = [
  {
    key: "risk",
    image: "/images/events/digpacks/risk-management.png",
  ...
  {
    key: "safety",
    image: "/images/events/digpacks/safety-lens.png",
    title: "Safety Lens",
    short: "A clearer starting point for environmental risk assessment",
    detail:
      "Safety Lens, part of Ligature Risk Management app, uses an app-integrated Copilot to analyse photographs of rooms or service environments and prepare a structured draft environmental risk assessment. It may be relevant to hospital-in-the-home, residential aged care, Supported Independent Living, mental health, disability and community service environments. It supports trained staff and does not replace professional judgement, consent, privacy controls or accountable approval.",
    cta: "Request a Safety Lens demonstration",
  },
  {
    key: "hr",
    image: "/images/events/digpacks/people-and-hr.png",
  ...
  {
    key: "vaccination",
    image: "/images/events/digpacks/vaccination-hub.png",
  ...
  {
    key: "pia",
    image: "/images/events/digpacks/privacy-impact-assessment.png",
  ...
  {
    key: "itsm",
    image: "/images/events/digpacks/it-service-management.png",
...
export default function SolutionsGrid() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
      {solutions.map(({ key, image, title, short, detail, cta }) => {
        ...
        return (
          ...
          >
            <div className="w-[100px] h-[100px] shrink-0 mb-4 relative">
              <Image
                src={image}
                alt=""
                fill
