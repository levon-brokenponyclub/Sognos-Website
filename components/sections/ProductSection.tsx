                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  {SOGNOSCARE_EDITIONS.map((edition) => (
                    <Link
                      ...
                      href={edition.href}
                      onClick={onClose}
                      className="group flex flex-col items-start gap-4 p-5 rounded-xl border border-gray-200 bg-gray-50 hover:border-[#4ECCD6] hover:bg-[#f0fdfd] transition-all duration-200"
                    >
                      <Image
                        src={edition.logo}
                        alt={edition.label}
                      ...
                      />
                      <span className="text-sm font-medium text-prussian-blue-800 leading-snug">
                        {edition.label}
                      </span>
                    </Link>
                  ))}
