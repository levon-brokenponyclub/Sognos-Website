...
const ARTICLES: Article[] = [
  {
    ...
    excerpt: "Today marks a major milestone — 9 years of Sognos. From a small team with a bold idea to a platform serving organisations across Australia, New Zealand, and beyond.",
    href: "/resources",
  ...
  },
  {
    ...
    excerpt: "We're thrilled to share that Sognos Solutions has officially moved to a new office in North Sydney — a space built to match our next chapter of growth.",
    href: "/resources",
  ...
  },
  {
    ...
    excerpt: "Sognos Solutions is proud to announce the official launch of our New Zealand operations — bringing our platform to service organisations across the Tasman.",
    href: "/resources",
  ...
  },
  {
    ...
    excerpt: "As we continue to grow and evolve, we are excited to announce the opening of our new office in India — expanding our delivery capability and global footprint.",
    href: "/resources",
  ...
  },
  {
    ...
    excerpt: "The Field Service Management Summit 2024 in Sydney brought together industry leaders to explore what's next in field service — and Sognos was there.",
    href: "/resources",
      ...
      <div className="flex flex-1 flex-col gap-3 p-6">
        ...
        <span
          className={`inline-flex w-fit items-center rounded-full border px-2.5 py-0.5 text-xs font-medium ${
            BADGE_STYLES[article.category] ?? "bg-neutral-50 text-neutral-600 border-neutral-100"
          }`}
        >
          {article.category}
        </span>
...
export default function NewsInsightSection() {
  ...
  return (
    <section className="w-full border-b border-sognos-border-subtle py-24 overflow-hidden">
      ...
      {/* Dot indicators */}
      <div className="mx-auto max-w-7xl px-6 mt-6 flex gap-1.5">
        {ARTICLES.map((_, i) => (
          <span
            key={i}
            className={`block h-1 rounded-full transition-all duration-300 ${
              i === activeIndex ? "w-6 bg-neutral-900" : "w-1.5 bg-neutral-200"
            }`}
          />
        ))}
      </div>
