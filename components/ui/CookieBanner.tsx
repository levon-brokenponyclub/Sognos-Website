...
export default function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 rounded-lg bg-sognos-navy px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg text-sm font-medium bg-sognos-blue-accent text-white hover:bg-sognos-blue-accent/90 transition-colors"
          >
            Accept
          </button>
        </div>
