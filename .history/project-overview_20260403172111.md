...
- Claude → Structure, content, component build, and must create \`claude.md\`
- Gemini → UI, styling, visual polish, and interaction direction
- Dev → Final implementation in Next.js

---

## Required Skills

The project requires the following core skills:
...
Claude must create and maintain a `claude.md` file.
...
- Open tasks / next tasks

This ensures Claude has a clear execution reference during build.
...
Speed is important, but clarity is critical.

Build fast, but never sacrifice:
